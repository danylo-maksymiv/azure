...
def update_address(request, pk):
    ...
    if instance and request.method == 'POST':
        eth_balance = request.POST.get('eth_balance', instance.eth_balance)
...
#curl -X DELETE http://localhost:8000/api/address/a16e1e1833bd2657076a3d470e26e00a2d33c835/ -H "Authorization: Token 004a013d572d01990665bce868622ce1261c5bce"